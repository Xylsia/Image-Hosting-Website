...
<html lang="en">
    ...
    <body>
		...
		<div class="middle">
            ...
            <h2 class="question">Have a question for Us? Fill out these..</h2>
            ...
            <form class="form" method="POST" action="contactAction.php">
                <label class="label">Title:</label><br /><input type="text" id="title" name="title" placeholder="Enter Title" size="50"/><span id="titleSpan"></span><br />
                <label class="label">Question:</label><br /><textarea id="textArea" name="textArea" placeholder="Write your Question here" cols="70" rows="9"></textarea><span id="textAreaSpan"></span><br />

                <?php
                    if(isset($_SESSION['usernameId'])){
                        echo "<button type=\"submit\" id=\"contactButton\" name=\"contactButton\">Submit</button><br /><br /><br />";
                    }
                    else{
                        echo "</br/><p class=\"loginWarning\">You need to be logged in!</p><br /><br /><br />";
                    } 
                ?>
